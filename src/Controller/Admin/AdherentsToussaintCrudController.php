...
class AdherentsToussaintCrudController extends AbstractCrudController
{
    ...
    {
    $generatePdfAction = Action::new('app_generate_pdf_toussaint', 'Générer PDF')
        ->linkToRoute('app_generate_pdf_toussaint');
    ...
    public function configureFields(string $pageName): iterable
    {
        $fields = [
            ...
            AssociationField::new('stage_toussaint')
                ->setLabel('Stage')
                ->onlyOnForms(),
            IntegerField::new('stage_toussaint')
                ->setLabel('Stage')
                ->hideOnForm()
    ...
    public function createIndexQueryBuilder(
        ...
        $queryBuilder->join('entity.stage_toussaint', 's'); 
    ...
    public function generatePdfAction(EntityManagerInterface $entityManager): Response
    {
        ...
        foreach ($adherents as $adherent) {
            foreach ($adherent->getStageToussaint() as $stage) {
