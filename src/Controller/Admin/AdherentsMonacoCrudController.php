...
class AdherentsMonacoCrudController extends AbstractCrudController
{
    private AdherentsWorkflow $adherentsWorkflow;
    ...
    {
    $generatePdfAction = Action::new('app_generate_pdf', 'Générer PDF')
        ->linkToRoute('app_generate_pdf');
    ...
    public function configureFields(string $pageName): iterable
    {
        $fields = [
            ...
            AssociationField::new('stage_ad')
                ->setLabel('Stage')
                ->onlyOnForms(),
            IntegerField::new('stage_ad')
                ->setLabel('Stage')
                ->hideOnForm()
    ...
    public function createIndexQueryBuilder(
        ...
        $queryBuilder->join('entity.stage_ad', 's'); 
...
public function generatePdfAction(EntityManagerInterface $entityManager): Response
    {
        ...
        foreach ($adherents as $adherent) {
            foreach ($adherent->getStageAd() as $stage) {
