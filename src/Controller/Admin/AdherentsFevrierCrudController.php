...
class AdherentsFevrierCrudController extends AbstractCrudController
{
    ...
    $generatePdfAction = Action::new('app_generate_pdf_fevrier', 'Générer PDF')
        ->linkToRoute('app_generate_pdf_fevrier');
    ...
    public function validate(AdminContext $context, AdminUrlGenerator $adminUrlGenerator): Response
    {
        ...
        if (!$adherents instanceof Adherents) {
            throw new \RuntimeException('Adhérent invalide');
        }
    ...
    public function configureFields(string $pageName): iterable
    {
        $fields = [
            ...
            AssociationField::new('stage_hiver')
                ->setLabel('Stage')
                ->onlyOnForms(),
            IntegerField::new('stage_hiver')
                ->setLabel('Stage')
                ->hideOnForm()
    ...
    public function createIndexQueryBuilder(
        ...
        $queryBuilder->join('entity.stage_hiver', 's'); 
    ...
    public function generatePdfAction(EntityManagerInterface $entityManager): Response
    {
        ...
        foreach ($adherents as $adherent) {
            foreach ($adherent->getStageHiver() as $stage) {
