...
use App\Repository\StagesPaquesRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: StagesPaquesRepository::class)]
class StagesPaques
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToMany(targetEntity: Adherents::class, mappedBy: 'stage_paques')]
    ...
    public function removeAdherent(Adherents $adherent): static
    {
        if ($this->adherents->removeElement($adherent)) {
            $adherent->removeStagePaque($this);
        }
