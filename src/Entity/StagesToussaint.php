...
use App\Repository\StagesToussaintRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: StagesToussaintRepository::class)]
class StagesToussaint
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToMany(targetEntity: Adherents::class, mappedBy: 'stage_toussaint')]
    ...
    public function addAdherent(Adherents $adherent): static
    {
        if (!$this->adherents->contains($adherent)) {
            ...
            $adherent->addStageToussaint($this);
        }
    ...
    public function removeAdherent(Adherents $adherent): static
    {
        if ($this->adherents->removeElement($adherent)) {
            $adherent->removeStageToussaint($this);
        }
